...
const faqItems = [
  ...
  { q: 'Do I need to reserve in advance?', a: 'We recommend booking in advance, especially on weekends and for classes, since spots are limited. Walk-ins are welcome, and we encourage checking the live occupancy status on our website before visiting.' },
  { q: 'How does payment work?', a: 'Classes and reservations are confirmed at the time of online booking and payment. Walk-in payment onsite is also available.' },
  { q: 'What is your cancellation policy?', a: 'We understand that plans can change. You can cancel or reschedule up to 24 hours in advance for credit toward a future visit.' },
