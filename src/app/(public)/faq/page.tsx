...
const faqItems = [
  ...
  { q: 'How does payment work?', a: 'Classes and party reservations (50% deposit) are confirmed at the time of online booking and payment. Walk-in payment onsite is also available.' },
  { q: 'What is your cancellation policy?', a: 'For classes (typically in collaboration with external instructors), cancellation, refund, or reschedule requests are available up to 3 days in advance. For parties, the 50% deposit is nonrefundable and the remaining 50% is paid upon arrival. One reschedule is allowed; if there is severe weather or an issue on our side, the booking can be rescheduled or refunded. Cancellation requests can also be discussed with us directly.' },
