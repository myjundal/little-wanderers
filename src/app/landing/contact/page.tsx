    ...
    <main style={{ padding: '16px clamp(12px, 4vw, 24px)', maxWidth: 760, margin: '0 auto' }}>
      <section style={{ border: '1px solid #e3d0fb', borderRadius: 22, background: 'linear-gradient(180deg,#fff,#f7efff)', padding: 18, boxShadow: '0 10px 20px rgba(120,87,177,0.08)' }}>
        ...
        <div style={{ display: 'grid', gap: 10 }}>
          <a style={{ border: '1px solid #d9c8f7', borderRadius: 12, padding: '10px 12px', textDecoration: 'none', color: '#5f3da4', background: '#fff' }} href="https://instagram.com/littlewanderers.weha" target="_blank" rel="noreferrer"><span style={iconWrap}><svg viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="5" stroke="#5f3da4" strokeWidth="2"/><circle cx="12" cy="12" r="4" stroke="#5f3da4" strokeWidth="2"/><circle cx="17.5" cy="6.5" r="1.2" fill="#5f3da4"/></svg></span>Instagram</a>
          <a style={{ border: '1px solid #d9c8f7', borderRadius: 12, padding: '10px 12px', textDecoration: 'none', color: '#5f3da4', background: '#fff' }} href="https://facebook.com/littlewanderers.weha" target="_blank" rel="noreferrer"><span style={iconWrap}><svg viewBox="0 0 24 24" fill="none"><path d="M13.5 21V13.5H16L16.5 10.5H13.5V8.9C13.5 8 13.9 7.5 15 7.5H16.6V4.8C16.3 4.7 15.3 4.5 14.1 4.5C11.6 4.5 10 6 10 8.8V10.5H7.5V13.5H10V21H13.5Z" fill="#5f3da4"/></svg></span>Facebook</a>
